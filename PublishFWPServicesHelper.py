    ...
    def publish(self):
        try:
            with FileGeodatabaseHelper() as file_geodb_helper:
                ...
                if hasattr(self._config,"keepoutput"):
                    file_geodb_helper.clean_up = not self._config.keepoutput == "true"
                    file_geodb_helper.cache_database_name()
